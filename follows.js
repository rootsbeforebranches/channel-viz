(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'QaRPZ6wk0lJNXkNRX2twiVhkULUyhRiadkrco0Q7kROmhfzh', // Unique master Xively API key to be used as a default
		defaultFeeds	= [243624454], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'ZEH feeds', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= '333333', // CSS HEX value of color to represent data (omit leading #)
